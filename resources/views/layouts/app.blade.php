        ...
        <div class="main_container">
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="#" class="site_title"><i class="fa fa-balance-scale"></i> <span>SGRD</span></a>
                    </div>
                    ...
                    <div class="profile clearfix">
                        <div class="profile_pic">
                            <img src="{{asset('assets/inicio/img/perfil.jpg')}}" alt="..." class="img-circle profile_img">
                        </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a href="{{url('getAllDenuncias')}}"><i class="fa fa-balance-scale"></i> Denuncias <span class="fa fa-chevron-right"></span></a>
                                </li>
                                <li><a><i class="fa fa-edit"></i> Más Opciones <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="form.html">Opcion 1</a></li>
                                        <li><a href="form_advanced.html">Opcion 1</a></li>
                                        <li><a href="form_validation.html">Opcion 1</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-file"></i> Reportes <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="{{url('reporteGeneral')}}">Por Ingreso</a></li>
                                        <li><a href="{{url('reporteDistrito')}}">Por Distrito</a></li>
                                        <li><a href="{{url('reporteFalta')}}">Por tipo de falta</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
            ...
            <footer>
                <div class="pull-right">
                    Sistema de gestión y registro de denuncias <a href="#">SGRD</a>
                </div>
                <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
