...
<h3 style="text-align: center;">REPORTE DE DENUNCIAS GENERAL POR TIPO DE FALTA</h3>
<span > <strong>Tipo de falta:</strong> {{$falta->nombreFalta}} </span><br>
<span><strong>Cantidad total de denuncias: </strong>{{$cantidad}}</span>
